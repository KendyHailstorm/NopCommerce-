...
WebUI.setText(findTestObject('Verify Adding Flower Girl  To CArt/input_Search Field'), Flower)

WebUI.click(findTestObject('Verify Adding Flower Girl  To CArt/button_Search'))

WebUI.click(findTestObject('Verify Adding Flower Girl  To CArt/link_Flower Girl Bracelet '))
